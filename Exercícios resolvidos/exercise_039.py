...
if idade < 18:
    print(f'\n\033[32mVocê ainda vai se alistar no serviço militar! Falta(m) {18 - idade} ano(s)')
elif idade == 18:
    print(f'\n\033[33mVocê está no ano de se alistar no serviço militar!')
else:
    print(f'\n\033[31mVocê já passou do prazo de se alistar no serviço militar a {idade - 18} ano(s)')
